<!-- translation-of: HANDOFF.md sha256:1350641eac9a8d60 -->
...
当前无发布阻断问题。Beta 1 已发布且公开下载复验通过。

## 下一步计划

记录本次发布回执，汇报指标，然后停止。后续版本需另行决定；不可移动 Beta 1 标签或替换制品。
...
归档检查排除字节码、私有 JSON、维护者路径和后续模块。公开提交为 a279f673e1febe809bcf6dc8c4765898d1ee2750。
CI 34080729594（分支）、34080824950（main）、34080827166（标签）均通过。
公开 wheel SHA-256：4d289d8ed873d78c8d845144472a148243347476280c639a5b7bffea419995e4。
公开 sdist SHA-256：2fd9dc3525810f61be86005728e60c573ee28923ea3921a3d202f106eb08a405。
三份制品重新下载全部匹配；公开 wheel／sdist 干净安装和模式检查通过。
发布后仓库指标：105 Star、3 订阅者（Watch）、6 Fork、0 未关闭 Issue。
于 2026-09-07T03:47:46Z 发布非 latest 预发布版。
