<!-- translation-of: UPDATE_MAP.md sha256:bf5922e7d552c4a8 -->
...
| “我希望 Codex 使用相关历史，不要让我重新讲一遍。” | Alpha 2 接受一份显式有界输入信封；Alpha 3 归一化支持的 Codex 导出并记录结构化排除项。 | Alpha 2／3 门禁 |
...
| 第 2 天 | `v0.2.0-alpha.2` | 增加一个显式有界输入信封，记录来源身份／摘要、目标／窗口、纳入／排除与真实覆盖；目录、主目录、符号链接越界、变化中和超限输入均拒绝。 |
