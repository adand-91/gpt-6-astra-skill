<!-- translation-of: UPDATE_MAP.md sha256:7458abe9c53f73e9 -->
...
| “我希望 Codex 使用相关历史，不要让我重新讲一遍。” | Alpha 2 绑定一份显式导出并内嵌有界输入信封；Alpha 3 归一化支持的现代 Codex 事件并记录语义排除项。 | Alpha 2 已交付；Alpha 3 待办 |
