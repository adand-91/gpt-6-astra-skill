<!-- translation-of: UPDATE_MAP.md sha256:fbf0191d496de7b6 -->
...
| “我希望 Codex 使用相关历史，不要让我重新讲一遍。” | Alpha 2 绑定一份显式导出并内嵌有界输入信封；Alpha 3 归一化支持的现代 Codex 事件并记录语义排除项。 | Alpha 2 已交付；Alpha 3 为发布候选 |
...
| 第 3 天 | `v0.2.0-alpha.3` | **发布候选；等待公开门禁。** 归一化支持的现代 Codex 导出：完成项目顺序、snapshot 去重、半开窗口和 automation／delegation 结构化排除；fixtures 含一个真实 named-Skill 形状的隐私案例。 |
